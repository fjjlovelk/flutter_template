...
class ThemeConfig {
  /// 默认颜色
  static Color primary = const Color(0xff1989FA);

  /// 信息色
  static Color info = const Color(0xff576B95);

  /// 成功色
  static Color success = const Color(0xff07c160);

  /// 报错色
  static Color error = const Color(0xffEE0A24);

  /// 警告色
  static Color warning = const Color(0xffFAAB0C);
